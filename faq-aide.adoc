...
La version 1.0.0 d'AIDE prend en charge la fonctionnalité de base de Metadata Engine sur des serveurs tiers utilisant du matériel fourni par le client. Les fonctionnalités complètes d'AIDE avec les fonctionnalités GPU nécessitent du matériel NetApp DCN.
