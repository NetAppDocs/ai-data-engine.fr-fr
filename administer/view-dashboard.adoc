...
. Développez un nœud DCN pour ouvrir la vue détaillée et vérifiez :
+
...
. Sélectionnez *Câblage* sur la page *Cluster > Vue d'ensemble* pour vérifier que les nœuds DCN sont correctement câblés aux commutateurs du cluster et pour identifier tout problème de port ou de liaison.
