...
* La licence des services premium AIDE est installée afin d’activer les fonctionnalités de garde-fous et d’inférence pour les capacités de gouvernance des données.
