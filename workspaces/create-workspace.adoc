...
* Vous avez déterminé les sources de données distantes (pairées) et locales que vous avez l'intention d'utiliser avec l'espace de travail et avec AIDE.
...
Créez un espace de travail et associez des containers de données contenant les données que vous souhaitez utiliser avec AIDE.
