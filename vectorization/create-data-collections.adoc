...
Vous effectuerez toutes les tâches de collecte de données dans AIDE Console.

.Avant de commencer
* Vous devez disposer des privilèges de _data engineer_ ou de _data scientist_ dans AIDE Console (`\https://<cluster_management_ip>/console`).
...
* La licence des services premium AIDE est installée et les fonctionnalités d'inférence sont activées pour la fonctionnalité Data Curator.
...
.Résultat
La définition de la collection et ses embeddings sont supprimés d'AIDE. Les applications tentant d'interroger l'ancien point de terminaison de récupération échoueront après la suppression de la collection.
