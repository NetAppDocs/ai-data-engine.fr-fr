...
.Avant de commencer
* Vous disposez déjà d'un système de stockage AFX 1K installé. Pour plus d'informations sur l'installation du système de stockage AFX 1K, consultez link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html["installez votre système de stockage AFX 1K"^].
...
Pour les Data Compute Node, les ports e4a/e5a sont utilisés pour les connexions au cluster.
...
.Et ensuite ?
Une fois le matériel câblé, vous link:power-on-hardware.html["Mettez sous tension vos Data Compute Node"].
